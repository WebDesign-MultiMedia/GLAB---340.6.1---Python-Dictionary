...
def network(servers):
    ...
    for hostname, IP_address in servers.items():
        ...
        # the hostname and IP_address cariables into the designed {} placeholders
        # within the string.
...
print(network({"Domain Name Server":"8.8.8.8", "Gateway Server": "192.168.1.1", "Print Server": "192.168.1.33", "Mall Server": "192.168.1.190"}))
